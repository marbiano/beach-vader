...
contract BeachVader is ERC721URIStorage {
  ...
  string[] phrases = ["He's as clumsy as he is stupid.", "You don't know the power of the dark side.", "I must obey my master.", "It has seen the end of Kenobi.", "It will soon see the end of the Rebellion.", "I am altering the deal, pray I don't alter it any further.", "Be careful not to choke on your aspirations.", "You have controlled your fear.", "Now, release your anger.", "Only your hatred can destroy me.", "The ability to destroy a planet is insignificant next to the power of the Force.", "No... I am your Father.", "I find your lack of faith disturbing."];
